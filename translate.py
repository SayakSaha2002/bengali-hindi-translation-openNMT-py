...
def translate(source, translator, sp_source_model, sp_target_model):
    ...
    Returns:
        str: Translation of the source text
    """
...
# File paths to the CTranslate2 SentencePiece models
ct_model_path = "bnhi_ctranslate2/"
sp_source_model_path = "dataset/source.model"
sp_target_model_path = "dataset/target.model"
...
# If the button is pressed, perform translation
if submitted:
